...
<html>
	...
	<body>
		<a href="#page-body" class="skip"><g:message code="default.link.skip.label" default="Skip to content&hellip;"/></a>
			...
			<p>Bienvenue dans notre application interactive Question/Reponses.</p>
			<p>
			...
			<div id="controller-list" role="navigation">
				...
				<g:each var="c" in="${grailsApplication.controllerClasses.sort { it.fullName } }">
					...
					<br>
					Si vous n'avez pas encore de compte, nous vous invitons à vous inscrire  <g:link controller="Etudiant" action="create"> ici si vous êtes Etudiant</g:link> 
					et  <g:link controller="Enseignant" action="create"> ici si vous êtes Eseignant</g:link> 
